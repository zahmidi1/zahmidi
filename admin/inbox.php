			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li> <a href="pricing.html"><i class="fe fe-vector"></i> <span>Inbox(21)</span></a> </li>
						<li> <a href="calendar.html"><i class="fe fe-vector"></i> <span>Starred</span></a> </li>
						<li> <a href="assest.html"><i class="fe fe-vector"></i> <span>Sent Mail</span></a> </li>
						<li> <a href="activities.html"><i class="fe fe-vector"></i> <span>Draft(8)</span></a> </li>
						<li> <a href="activities.html"><i class="fe fe-vector"></i> <span>Trash</span></a> </li>
					</ul>
				</div>
			</div>
		</div>
										...
										<div class="float-left">
											<div class="btn-group dropdown-action">
												...
												<div class="dropdown-menu"> <a class="dropdown-item" href="#">All</a> <a class="dropdown-item" href="#">None</a>
													<div class="dropdown-divider"></div> <a class="dropdown-item" href="#">Read</a> <a class="dropdown-item" href="#">Unread</a>
												</div>
											</div>
											<div class="btn-group dropdown-action">
												...
												<div class="dropdown-menu"> <a class="dropdown-item" href="#">Reply</a>
													<a class="dropdown-item" href="#">Forward</a> <a class="dropdown-item" href="#">Archive</a>
													<div class="dropdown-divider"></div> <a class="dropdown-item" href="#">Mark As Read</a> <a class="dropdown-item" href="#">Mark
														As Unread</a>
											...
											<div class="btn-group dropdown-action">
												...
												<div role="menu" class="dropdown-menu"> <a class="dropdown-item" href="#">Social</a> <a class="dropdown-item" href="#">Forums</a>
													<a class="dropdown-item" href="#">Updates</a>
													<div class="dropdown-divider"></div> <a class="dropdown-item" href="#">Spam</a> <a class="dropdown-item" href="#">Trash</a>
													<div class="dropdown-divider"></div> <a class="dropdown-item" href="#">New</a>
												</div>
											</div>
											<div class="btn-group dropdown-action">
												...
												<div role="menu" class="dropdown-menu"> <a class="dropdown-item" href="#">Work</a> <a class="dropdown-item" href="#">Family</a>
													<a class="dropdown-item" href="#">Social</a>
													<div class="dropdown-divider"></div> <a class="dropdown-item" href="#">Primary</a> <a class="dropdown-item" href="#">Promotions</a> <a class="dropdown-item" href="#">Forums</a>
												</div>
											</div>
										</div>
