...
?>
    ...
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="https://lesjardinsdassilah.com/wp-content/uploads/2016/11/favicon-32x32-1.png">
        ...
        <div class="main-wrapper">
            <div class="header">
                <div class="header-left">
                    ...
                    <a href="index" class="logo logo-small"> <img src="assets/img/Logo.png" alt="Logo" width="30" height="30"> </a>
                </div>
                ...
                <ul class="nav user-menu">
                    <li class="nav-item dropdown noti-dropdown">
                        ...
                        <div class="dropdown-menu notifications">
                            <div class="topnav-dropdown-header"> <span class="notification-title">Notificationt</span> <a href="javascript:void(0)" class="clear-noti"> Clear All </a> </div>
                    ...
                    <li class="nav-item dropdown has-arrow">
                        ...
                        <div class="dropdown-menu">
                            ...
                            </div> <a class="dropdown-item" href="profile">My Profile</a> <a class="dropdown-item" href="settings">Account Settings</a> <a class="dropdown-item" href="./php/logout.php">Logout</a>
                        </div>
                    </li>
                </ul>
